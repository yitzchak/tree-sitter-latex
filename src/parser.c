...
enum {
  ...
  anon_sym_LBRACK = 29,
  anon_sym_RBRACK = 30,
  sym_display_math_env_name = 31,
  anon_sym_LPAREN = 32,
  anon_sym_RPAREN = 33,
  sym_inline_math_env_name = 34,
  anon_sym_tag = 35,
  sym_verbatim_env_name = 36,
  anon_sym_begin = 37,
  anon_sym_end = 38,
  anon_sym_documentclass = 39,
  anon_sym_usepackage = 40,
  aux_sym_SLASHinclude_PIPEinput_SLASH = 41,
  anon_sym_STAR = 42,
  aux_sym_SLASHsection_PIPEsubsection_PIPEsubsubsection_PIPEparagraph_PIPEsubparagraph_PIPEchapter_PIPEpart_PIPEaddpart_PIPEaddchap_PIPEaddsec_PIPEminisec_SLASH = 43,
  aux_sym_SLASH_LBRACKegx_RBRACK_QMARKdef_SLASH = 44,
  anon_sym_EQ = 45,
  aux_sym_SLASHk_QMARKcatcode_BQUOTE_SLASH = 46,
  anon_sym_emph = 47,
  anon_sym_footnote = 48,
  anon_sym_textbf = 49,
  anon_sym_textit = 50,
  anon_sym_texttt = 51,
  ...
  anon_sym_minus = 65,
  anon_sym_href = 66,
  aux_sym_SLASH_LPARENnolink_RPAREN_QMARKurl_SLASH = 67,
  anon_sym_hyperbaseurl = 68,
  anon_sym_hyperimage = 69,
  anon_sym_hyperref = 70,
  aux_sym_SLASH_LBRACK_CARET_BSLASH_RBRACK_BSLASH_LBRACK_RBRACK_SLASH = 71,
  aux_sym_SLASH_DOT_SLASH = 72,
  sym_unit = 73,
  sym_decimal = 74,
  sym_number = 75,
  sym_document = 76,
  sym__common = 77,
  sym_inline_verbatim = 78,
  sym_verb_token = 79,
  sym__text_mode = 80,
  sym_text_mode = 81,
  sym__math_mode = 82,
  ...
  sym_text_env = 85,
  sym_math_env = 86,
  sym__display_math = 87,
  sym_tex_display_math = 88,
  sym_latex_display_math = 89,
  sym_begin_display_math = 90,
  sym_end_display_math = 91,
  sym_display_math_env = 92,
  sym_display_math_begin = 93,
  sym_display_math_end = 94,
  sym_display_math_env_group = 95,
  sym__inline_math = 96,
  sym_tex_inline_math = 97,
  sym_latex_inline_math = 98,
  sym_begin_inline_math = 99,
  sym_end_inline_math = 100,
  sym_inline_math_env = 101,
  sym_inline_math_begin = 102,
  sym_inline_math_end = 103,
  sym_inline_math_env_group = 104,
  sym_tag = 105,
  sym_tag_token = 106,
  sym_verbatim_env = 107,
  sym_verbatim_begin = 108,
  sym_verbatim_end = 109,
  sym_verbatim_text = 110,
  sym_verbatim_env_group = 111,
  sym_begin = 112,
  sym_begin_token = 113,
  sym_end = 114,
  sym_end_token = 115,
  sym_documentclass = 116,
  sym_documentclass_token = 117,
  sym_usepackage = 118,
  sym_usepackage_token = 119,
  sym_include = 120,
  sym_include_token = 121,
  sym_providesexplclass = 122,
  sym_providesexplclass_token = 123,
  sym_providesexplfile = 124,
  sym_providesexplfile_token = 125,
  sym_providesexplpackage = 126,
  sym_providesexplpackage_token = 127,
  sym_section = 128,
  sym_section_token = 129,
  sym_storage = 130,
  sym_storage_token = 131,
  sym_catcode = 132,
  sym_catcode_token = 133,
  sym_emph = 134,
  sym_emph_token = 135,
  sym_footnote = 136,
  sym_footnote_token = 137,
  sym_textbf = 138,
  sym_textbf_token = 139,
  sym_textit = 140,
  sym_textit_token = 141,
  sym_texttt = 142,
  sym_texttt_token = 143,
  sym_makeatletter = 144,
  sym_makeatletter_token = 145,
  sym_makeatother = 146,
  sym_makeatother_token = 147,
  sym_explsyntaxon = 148,
  sym_explsyntaxon_token = 149,
  sym_explsyntaxoff = 150,
  sym_explsyntaxoff_token = 151,
  sym_dimension_assign = 152,
  sym_glue_assign = 153,
  sym_glue_token = 154,
  sym_dimension_token = 155,
  sym_glue_space = 156,
  sym_glue_space_token = 157,
  sym_makebox = 158,
  sym_strut = 159,
  sym_strut_token = 160,
  sym_phantom_smash = 161,
  sym_phantom_smash_token = 162,
  sym_makebox_token = 163,
  sym_usebox = 164,
  sym_usebox_token = 165,
  sym_movebox = 166,
  sym_movebox_token = 167,
  sym__box = 168,
  sym_setbox = 169,
  sym_setbox_token = 170,
  sym_box_dimension_assign = 171,
  sym_box_dimension_token = 172,
  sym_glue = 173,
  sym_box_dimension_ref = 174,
  sym_dimension = 175,
  sym_href = 176,
  sym_href_token = 177,
  sym_url = 178,
  sym_url_token = 179,
  sym_hyperbaseurl = 180,
  sym_hyperbaseurl_token = 181,
  sym_hyperimage = 182,
  sym_hyperimage_token = 183,
  sym_hyperref = 184,
  sym_hyperref_token = 185,
  sym_text_group = 186,
  sym_name_group = 187,
  sym_opt_text_group = 188,
  sym_math_group = 189,
  ...
  sym_token = 194,
  sym_escaped = 195,
  aux_sym_text_mode_repeat1 = 196,
  aux_sym_math_mode_repeat1 = 197,
  aux_sym_parameter_repeat1 = 198,
  aux_sym_verbatim_text_repeat1 = 199,
  aux_sym_text_repeat1 = 200,
  aux_sym_token_repeat1 = 201,
  anon_alias_sym_name = 202,
  anon_alias_sym_text = 203,
};
