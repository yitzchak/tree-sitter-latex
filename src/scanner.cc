...
struct Scanner {
  ...
  unordered_map<string, CatCodeCommand> control_sequences = {
      ...
      {"DeclareRobustCommand", {cs_newcommand, false, {}}},
      {"def", {cs_def, false, {}}},
      ...
      {"newenvironment", {cs_newenvironment, false, {}}},
      {"newcommand", {cs_newcommand, false, {}}},
      ...
      {"ProvidesExplFile",
       {cs,
        ...
        {{{'\t', '\t', IGNORED_CATEGORY},
          ...
          {'|', '|', OTHER_CATEGORY},
          {'~', '~', SPACE_CATEGORY}}}}},
      {"providecommand", {cs_newcommand, false, {}}},
      {"ProvidesExplPackage",
       {cs,
        false,
        {{{'\t', '\t', IGNORED_CATEGORY},
      ...
      {"renewcommand", {cs_newcommand, false, {}}},
      {"renewenvironment", {cs_newenvironment, false, {}}},
