...
unordered_map<string, SymbolDescription> Scanner::control_sequences = {
    ...
    {"makeatletter", {cs_makeatletter, {{'@', '@', LETTER_CATEGORY}}}},
    {"makeatother", {cs_makeatother, {{'@', '@', OTHER_CATEGORY}}}},
    {"makebox", cs_makebox},
    ...
    {"ProvidesClass", {cs_Provides, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesFile", {cs_Provides, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesPackage", {cs_Provides, {{'@', '@', LETTER_CATEGORY}}}},
