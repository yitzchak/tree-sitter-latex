...
unordered_map<string, CatCodeCommand> Scanner::control_sequences = {
    ...
    {"makeatletter",
     {cs_makeatletter, MF_Any, false, {{'@', '@', LETTER_CATEGORY}}}},
    {"makeatother",
     {cs_makeatother, MF_Any, false, {{'@', '@', OTHER_CATEGORY}}}},
    {"makebox", cs_makebox},
    ...
    {"ProvidesClass",
     {cs_Provides, MF_Any, false, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesFile",
     {cs_Provides, MF_Any, false, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesPackage",
     {cs_Provides, MF_Any, false, {{'@', '@', LETTER_CATEGORY}}}},
    ...
    {"restorecr", {cs_restorecr, MF_Any, false, {{'\n', '\n', EOL_CATEGORY}}}},
