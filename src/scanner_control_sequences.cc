...
unordered_map<string, SymbolDescription> Scanner::control_sequences = {
    // initex
    ...
    {"(", {cs_inline_math_begin, M_Math}},
    {")", cs_inline_math_end},
    {"[", {cs_display_math_begin, M_Math}},
    {"]", cs_display_math_end},
    // {"\\", cs_newline},
    {"acute", cs_mathaccent},
    ...
    {"ensuremath", {cs_ensuremath, M_Math}},
    ...
    {"makeatletter", {cs_makeatletter, M_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"makeatother", {cs_makeatother, M_None, {{'@', '@', OTHER_CATEGORY}}}},
    {"makebox", cs_makebox},
    ...
    {"ProvidesClass", {cs_Provides, M_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesFile", {cs_Provides, M_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesPackage", {cs_Provides, M_None, {{'@', '@', LETTER_CATEGORY}}}},
