...
unordered_map<string, CatCodeCommand> Scanner::control_sequences = {
    ...
    {"catcode", cs_code},
    {"csname", cs_csname},
    {"def", {cs_def, MF_Text, false, MF_Nil}},
    {"delcode", cs_code},
    {"edef", cs_def},
    {"egroup", cs_egroup},
    ...
    {"kcatcode", cs_code},
    {"lccode", cs_code},
    {"left", {cs_left, MF_Math}},
    {"let", cs_let},
    {"mathcode", cs_code},
    {"par", cs_par},
    {"phantom", cs_phantom_smash},
    {"right", {cs_right, MF_Math}},
    {"sfcode", cs_code},
    ...
    {"text", cs_text},
    // latex base doc-sty
    {"DoNotIndex", {cs_DoNotIndex, MF_Text, false, MF_Nil}},
    // latex base latex-ltx
    {"@ifpackagelater", {cs_at_ifpackagelater, MF_Text, false, MF_Nil}},
    {"(", {cs_inline_math_begin, MF_Text}},
    {")", {cs_inline_math_end, MF_Math}},
    {"[", {cs_display_math_begin, MF_Text}},
    {"]", {cs_display_math_end, MF_Math}},
    // {"\\", cs_newline},
    {"acute", {cs_mathaccent, MF_Math}},
    ...
    {"author", cs_author},
    {"bar", {cs_mathaccent, MF_Math}},
    {"begin", cs_begin},
    {"bibitem", cs_bibitem},
    {"breve", {cs_mathaccent, MF_Math}},
    {"chapter", cs_section},
    {"check", {cs_mathaccent, MF_Math}},
    {"CheckCommand", {cs_CheckCommand, MF_Text, false, MF_Nil}},
    {"ClassError", cs_Error},
    ...
    {"dot", {cs_mathaccent, MF_Math}},
    {"emph", cs_emph},
    {"end", cs_end},
    {"endinput", cs_endinput},
    {"enlargethispage", cs_enlargethispage},
    {"ensuremath", {cs_ensuremath, MF_Any, false, MF_Math}},
    ...
    {"frac", {cs_frac, MF_Math}},
    {"framebox", cs_makebox},
    {"grave", {cs_mathaccent, MF_Math}},
    {"hat", {cs_mathaccent, MF_Math}},
    {"hspace", cs_space},
    ...
    {"makeatletter",
     {cs_makeatletter, MF_Any, false, MF_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"makeatother",
     {cs_makeatother, MF_Any, false, MF_None, {{'@', '@', OTHER_CATEGORY}}}},
    {"makebox", cs_makebox},
    ...
    {"mathring", {cs_mathaccent, MF_Math}},
    {"mathrm", cs_mathstyle},
    {"mathsf", cs_mathstyle},
    {"mathtt", cs_mathstyle},
    {"mbox", cs_mbox},
    ...
    {"newcommand", {cs_newcommand, MF_Text, false, MF_Nil}},
    {"newcounter", cs_newcounter},
    {"newenvironment", {cs_newenvironment, MF_Text, false, MF_Nil}},
    {"newfont", cs_newfont},
    ...
    {"obeycr",
     {cs_obeycr, MF_Any, false, MF_None, {{'\n', '\n', ACTIVE_CHAR_CATEGORY}}}},
    ...
    {"ProvidesClass",
     {cs_Provides, MF_Any, false, MF_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesFile",
     {cs_Provides, MF_Any, false, MF_None, {{'@', '@', LETTER_CATEGORY}}}},
    {"ProvidesPackage",
     {cs_Provides, MF_Any, false, MF_None, {{'@', '@', LETTER_CATEGORY}}}},
    ...
    {"restorecr", {cs_restorecr, MF_Any, false, MF_None, {{'\n', '\n', EOL_CATEGORY}}}},
    ...
    {"tilde", {cs_mathaccent, MF_Math}},
    {"title", cs_title},
    {"usebox", cs_usebox},
    {"usepackage", cs_use},
    {"value", cs_value},
    {"vec", {cs_mathaccent, MF_Math}},
    {"verb", cs_verb},
    {"vspace", cs_space},
    {"widehat", {cs_mathaccent, MF_Math}},
    {"widetilde", {cs_mathaccent, MF_Math}},
