...
unordered_map<string, Environment> Scanner::environments = {
    ...
    {"align", {env_name_display_math, MF_Text, MF_Math}},
    {"align*", {env_name_display_math, MF_Text, MF_Math}},
    {"alignat", {env_name_alignat, MF_Text, MF_Math}},
    {"alignat*", {env_name_alignat, MF_Text, MF_Math}},
    {"equation*", {env_name_display_math, MF_Text, MF_Math}},
    {"flalign", {env_name_display_math, MF_Text, MF_Math}},
    {"flalign*", {env_name_display_math, MF_Text, MF_Math}},
    {"gather", {env_name_display_math, MF_Text, MF_Math}},
    {"gather*", {env_name_display_math, MF_Text, MF_Math}},
    {"multiline", {env_name_display_math, MF_Text, MF_Math}},
    {"multiline*", {env_name_display_math, MF_Text, MF_Math}},
    {"split", {env_name_display_math, MF_Text, MF_Math}},
    {"split*", {env_name_display_math, MF_Text, MF_Math}},
    ...
    {"array", {env_name_array, MF_Math}},
    {"description", env_name_itemize},
    {"displaymath", {env_name_display_math, MF_Text, MF_Math}},
    {"document", env_name_document},
    {"enumerate", env_name_itemize},
    {"eqnarray", {env_name_display_math, MF_Text, MF_Math}},
    {"eqnarray*", {env_name_display_math, MF_Text, MF_Math}},
    {"equation", {env_name_display_math, MF_Text, MF_Math}},
    ...
    {"math", {env_name_inline_math, MF_Text, MF_Math}},
    ...
    {"darray", {env_name_dmath, MF_Text, MF_Math}},
    {"darray*", {env_name_dmath, MF_Text, MF_Math}},
    {"dgroup", {env_name_dmath, MF_Text, MF_Math}},
    {"dgroup*", {env_name_dmath, MF_Text, MF_Math}},
    {"dmath", {env_name_dmath, MF_Text, MF_Math}},
    {"dmath*", {env_name_dmath, MF_Text, MF_Math}},
    {"dseries", {env_name_dseries, MF_Text}},
    {"dseries*", {env_name_dseries, MF_Text}},
